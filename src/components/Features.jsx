...
const BentoCard = ({ src, title, description }) => {
  ...
  return (
    <div className="relative size-full" onMouseEnter={handleMouseEnter}
      ...
      />
      <div className="relative z-10 flex size-full fex-col justify-between p-5 text-blue-50">
        <div>
        ...
        <div className="grid h-[135vh] grid-cols-2 grid-rows-3 gap-7">
          ...
          <BentoTilt className="bento-tilt_2">
            <div className="flex size-full flex-col justify-between bg-violet-300 p-5">
              <h1 className="bento-title special-font max-w-64 text-black">M<b>0</b>re c<b>o</b>ming s<b>o</b>on!</h1>
